...
const ModuleLessonListScreen = ({
  ...
  if (!module) {
    return (
      <div className="p-4 min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
              ...
              <div key={lesson.id} className="relative">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className={`relative flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center text-lg font-bold border-2 ${
                      isCompleted
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        {isAvailable && !isCompleted && (
                          <div className="flex items-center space-x-1 bg-blue-600/20 border border-blue-600/30 rounded-full px-2 py-1">
                        ...
                        {isLocked && (
                          <div className="flex items-center space-x-1 bg-slate-600/20 border border-slate-600/30 rounded-full px-2 py-1">
