...
const NotificationSystem = ({ notifications, onMarkAsRead, onClearAll }: NotificationSystemProps) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Notification Panel */}
      {isOpen && (
        <div className="absolute top-12 right-0 w-80 bg-slate-800 rounded-xl shadow-2xl border border-slate-700 z-50">
