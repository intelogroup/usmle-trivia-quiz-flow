    ...
    return <div className="p-4 pb-20 space-y-6">
        ...
        <div className="space-y-3">
          {categories.map(category => <div key={category.id} className="bg-slate-800 rounded-xl overflow-hidden">
              ...
              <div className="p-2">
                {category.subcategories.map((subcategory, index) => <button key={index} onClick={() => handleSubcategoryClick(category.name, subcategory)} className="w-full flex items-center justify-between p-3 hover:bg-slate-700 rounded-lg transition-colors text-left">
  ...
  return <div className="p-4 pb-20 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-slate-800 rounded-xl p-4 space-y-3">
          ...
          <button onClick={handleContinueStudying} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg transition-colors">
            Continue Studying
          </button>
        </div>
      </div>
