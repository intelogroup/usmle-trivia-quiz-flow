...
const QuizConfigurationScreen = ({ 
  ...
  const difficultyOptions = [
    { value: 'easy', label: 'Easy', description: 'Basic concepts', color: 'text-green-400 bg-green-900/30' },
    { value: 'medium', label: 'Medium', description: 'Intermediate level', color: 'text-yellow-400 bg-yellow-900/30' },
    { value: 'hard', label: 'Hard', description: 'Advanced topics', color: 'text-red-400 bg-red-900/30' },
    { value: 'mixed', label: 'Mixed', description: 'All difficulty levels', color: 'text-blue-400 bg-blue-900/30' }
  ];
  ...
  return (
    <div className="p-4 pb-20 space-y-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-xl font-bold text-white">Configure Quiz</h1>
      ...
      <div className="fixed bottom-20 left-4 right-4 max-w-md mx-auto">
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg flex items-center justify-center space-x-2"
        >
