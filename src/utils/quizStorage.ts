...
import { updateUserProfile, updateAchievements, updateSubjectStats } from "./profileManager";
import { getUserProfile, getAchievements, getSubjectStats } from "./dataManager";
...
export const saveQuizResult = (result: QuizResult): void => {
  try {
    ...
    // Regenerate leaderboard by directly calling the function
    const { generateMockLeaderboard } = require('./leaderboardManager');
